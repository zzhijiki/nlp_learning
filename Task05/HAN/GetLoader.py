...
class GetLoader:
    ...
    def get_iter(self):
        ...
        self.train_loader = DataLoader(self.train_dataset, batch_size=64, collate_fn=collate_fn_train,shuffle=True)
        self.valid_loader = DataLoader(self.valid_dataset, batch_size=128, collate_fn=collate_fn_train)
        self.test_loader = DataLoader(self.test_dataset, batch_size=128, collate_fn=collate_fn_test)
